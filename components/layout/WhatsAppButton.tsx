/*
  ...
  bottom-20 (80 px) keeps it clear of the sticky admission bar (~52 px)
  and any footer content. z-50 always renders above z-40 sticky bar.
*/
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="
        fixed bottom-20 right-5 sm:right-6 z-50
