  ...
  return (
    <>
      ...
      >
        ...
        {/* Rouge radial glow behind heading */}
        <div
          className="absolute top-0 left-1/3 -translate-x-1/2 w-[600px] h-[300px] -translate-y-1/2 pointer-events-none"
          style={{ background: "radial-gradient(ellipse at center, rgba(150,0,24,0.16) 0%, transparent 70%)" }}
          aria-hidden
        />
        ...
        >
          <span
            ...
            style={{ fontSize: "32vw", color: "rgba(255,255,255,0.02)" }}
          >
            A
          </span>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          ...
          >
            <span className="w-1.5 h-1.5 rounded-full shrink-0" style={{ background: "#960018" }} aria-hidden />
            Informations &amp; vie de l&apos;école
          </p>

          {/* Title */}
          <h1
            className="font-display font-semibold text-white tracking-tight leading-tight mb-5"
            style={{
          ...
          >
            Actualités de<br />Montagne Rouge
          </h1>

          {/* Subtitle */}
          <p
            className="text-[16px] max-w-md leading-relaxed"
            style={{
          ...
          >
            La vie de l&apos;école au quotidien — événements, résultats, annonces et informations pratiques.
          </p>
        </div>
